...
<body>
    <div class="container">
        <div class="border border-dark rounded mt-4">
            ...
            <form action="../controller/proses.php" method="POST" class="m-4" enctype="multipart/form-data">
                <label for="" class="fw-bold">ID Pengaduan : </label>
                ...
                <textarea name="tanggapan" id="" cols="10" rows="4" class="form-control rounded"></textarea>
                <br>
