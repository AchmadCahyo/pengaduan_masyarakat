...
if ($exe && $exe2) {    
    echo "<script>alert('Tanggapan TERKIRIM!'); document.location.href='../petugas/inbox.php'</script>";

} else {
    echo "<script>alert('Tanggaoan GAGAL TERKIRIM!'); document.location.href='../petugas/inbox.php'</script>";
}